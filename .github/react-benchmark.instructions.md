...
In `@preact/signals` benchmark variants, read `.value` before passing the value into JSX. Passing a Signal object directly uses Preact's browser-oriented DOM mutation path and bypasses the ReactLynx snapshot update pipeline.
